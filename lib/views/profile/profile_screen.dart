...
class ProfileInfoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final personal = profile.personalDetail;
    final nationality =
        personal?.nationalityInfo?.nationality ?? "Not specified";
    ...
    if (profile.academicDetails!.isNotEmpty) {
      ...
      course =
          acad?.qualificationAchieved ?? acad?.levelOfStudy ?? "Not specified";
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          ProfileInfoRow(icon: Icons.school, label: "Course", value: course),
          ProfileInfoRow(
            icon: Icons.account_balance,
            label: "University",
            value: university,
          ),
          ProfileInfoRow(icon: Icons.event, label: "Intake", value: intake),
          ProfileInfoRow(
